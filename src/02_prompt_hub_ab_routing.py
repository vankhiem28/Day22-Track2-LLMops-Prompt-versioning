...
PROMPT_V1_NAME = "vankhiem-rag-prompt-v1"
PROMPT_V2_NAME = "vankhiem-rag-prompt-v2"


# ── 2. Định nghĩa 2 Prompt Templates ──────────────────────────────────────
SYSTEM_V1 = (
    "Bạn là trợ lý AI hữu ích. Chỉ dùng context sau để trả lời câu hỏi của người dùng. "
    "Nếu context không chứa thông tin cần thiết, hãy trả lời: 'Tôi không biết.' "
...
SYSTEM_V2 = (
    "Bạn là chuyên gia AI với nhiều năm kinh nghiệm. Đọc kỹ context được cung cấp, "
    "xác định các facts liên quan, sau đó viết câu trả lời rõ ràng và có tổ chức (3-5 câu). "
    "Cấu trúc câu trả lời: (1) câu trả lời trực tiếp, (2) giải thích ngắn dựa trên context, "
    "(3) kết luận. Chỉ dùng thông tin từ context, không bịa thêm. "
    "Context:\n{context}"
)
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        url = client.push_prompt(
            PROMPT_V1_NAME,
            object=PROMPT_V1,
            description="V1 – ngắn gọn, 2-4 câu, đi thẳng vào vấn đề",
        )
    ...
    try:
        url = client.push_prompt(
            PROMPT_V2_NAME,
            object=PROMPT_V2,
            description="V2 – có cấu trúc, expert tone, 3-5 câu",
        )
